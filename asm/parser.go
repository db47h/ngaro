...
// ErrAsm encapsulates errors generated by the assembler. Some errors like duplicate
// declarations are followed by an entry giving the location of the first declaration.
type ErrAsm []struct {
